...
walk_iso_map = tm_basemap(server="Esri.WorldImagery", alpha=0.5) +
    ...
    tm_shape(mutate(ccc_link, label="New link")) +
        tm_lines(lwd=3, col="label", col.scale = tm_scale(values=c("orange")), col.legend=tm_legend(show=T, title="", position=tm_pos_out("right", "center"))
            )
...
acc_map = tm_basemap(
  ...
  tm_polygons(
    ...
    fill.scale = tm_scale_intervals(
      style = "fixed",
      breaks = c(1, 500, 1000, 5000, 10000, 105000),
