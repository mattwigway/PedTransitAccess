```{r}
# note: currently using a custom build of R5, https://github.com/mattwigway/r5/tree/configurable-linking-distance
# PR opened: https://github.com/conveyal/r5/pull/974
...
tm_shape(isos) +
    ...
    tm_shape(points) +
        ...
        tm_facets_wrap(by="loc") +
    tm_scalebar(position=tm_pos_out("left", "bottom")) +
    tm_credits("Basemap © OpenStreetMap contributors, Mapbox", position=tm_pos_out("right", "bottom"))
